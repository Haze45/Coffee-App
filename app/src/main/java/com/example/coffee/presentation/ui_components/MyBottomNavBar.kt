package com.example.coffee.presentation.ui_components
...
fun MyBottomNavBar(navController: NavController, routes: String) {
    val navItems = listOf(
        ...
        NavItem("Cart", icon = R.drawable.regular_outline_bag, Routes.CartScreen),
        NavItem("Favourite", icon = R.drawable.regular_outline_heart, Routes.FavouriteScreen),
